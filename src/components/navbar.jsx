...
function Navbar() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-col items-start gap-6 p-6 pt-20 font-semibold text-lg text-black">
          <div onClick={goToDomestic} className="cursor-pointer w-full p-2 hover:rounded-2xl hover:bg-[#cff1e1ae]">DOMESTIC</div>
          <div onClick={gotoInternational} className="cursor-pointer w-full p-2 hover:rounded-2xl hover:bg-[#cff1e1ae]">INTERNATIONAL</div>
          <div onClick={goToContact} className="cursor-pointer w-full p-2 hover:rounded-2xl hover:bg-[#cff1e1ae]">CONTACT</div>
          <div onClick={goToAbout} className="group cursor-pointer w-full p-2 hover:rounded-2xl hover:bg-[#cff1e1ae]">
            ABOUT
      ...
      <div className="hidden md:flex justify-between items-center h-14 w-full p-2 px-20">
        ...
        <div className="menu-box flex justify-between items-center w-[60%] text-sm font-semibold gap-2">
          <div onClick={goToDomestic} className="cursor-pointer hover:scale-110">DOMESTIC</div>
          <div onClick={gotoInternational} className="cursor-pointer hover:scale-110">INTERNATIONAL</div>
          <div onClick={goToContact} className="cursor-pointer hover:scale-110">CONTACT</div>
          <div onClick={goToAbout} className="group cursor-pointer hover:scale-110">
            ABOUT
